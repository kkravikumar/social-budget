/*! jQRangeSlider 5.5.0 - 2013-11-02 - Copyright (C) Guillaume Gautreau 2012 - MIT and GPLv3 licenses.*/ ! function(a) {
 "use strict";
...
function(a) {
 ...
 a.widget("ui.rangeSliderHandle", a.ui.rangeSliderDraggable, {
  ...
  _left: 0,
  _create: function() {
   a.ui.rangeSliderDraggable.prototype._create.apply(this), this.options.isLeft ? this.element.css("position", "fixed") : this.element.css("position", "absolute").css("top", 0).addClass("ui-rangeSlider-handle").toggleClass("ui-rangeSlider-rightHandle", !this.options.isLeft), this.element.append("<div class='ui-rangeSlider-handle-inner' />"), this._value = this._constraintValue(this.options.value)
  },
  destroy: function() {
...
function(a) {
 ...
 a.widget("ui.rangeSliderLabel", a.ui.rangeSliderMouseTouch, {
  ...
  _value: null,
  _create: function() {
   if (this._handle("option", "isLeft") == false) {
