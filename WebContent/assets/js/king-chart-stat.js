$(document).ready(function(){
	...
	function chartMonth(placeholder,duration) {
		...
		if (duration == 'daily') {
			yourBurn =[
				[gt(2016, 9, 1), 6.5], [gt(2016, 9, 2), 239.56], [gt(2016, 9, 5), 323.1], [gt(2016, 9, 6), 355.6],[gt(2016, 9, 8), 562.49], [gt(2016, 9, 9),748.5]
			];
				val =[
				[gt(2016, 9, 1), 100.70], [gt(2016, 9, 2), 274.72], [gt(2016, 9, 3), 454.60], [gt(2016, 9, 4), 609.80], [gt(2016, 9, 5), 658.19], [gt(2016, 9, 6), 713.84]
			];
		} else {
				yourSpend = [
				...
				yourBurn = [
						[gt(2016, 9, 1), 100.70], [gt(2016, 9, 2), 174.72], [gt(2016, 9, 3), 190.60], [gt(2016, 9, 4), 255.80], [gt(2016, 9, 5), 279.19], [gt(2016, 9, 6), 303.84], [gt(2016, 9, 7), 324.39],
						[gt(2016, 9, 8), 351.83], [gt(2016, 9, 9), 457.39], [gt(2016, 9, 10), 465.17], [gt(2016, 9, 11), 515.05], [gt(2016, 9, 12), 576.20], [gt(2016, 9, 13), 626.24], [gt(2016, 9, 14), 667.35],
						[gt(2016, 9, 15), 685.70], [gt(2016, 9, 16), 698.95], [gt(2016, 9, 17), 759.91], [gt(2016, 9, 18), 776.77], [gt(2016, 9, 19), 826.94], [gt(2016, 9, 20), 841.26], [gt(2016, 9, 21), 845.38],
						[gt(2016, 9, 22), 940.29]
					];
				
				socialBurn = [
						[gt(2016, 9, 1), 6.5], [gt(2016, 9, 2), 139.56], [gt(2016, 9, 5), 256.54], [gt(2016, 9, 6), 289.6],
						[gt(2016, 9, 8), 307.49], [gt(2016, 9, 9),401.5], [gt(2016, 9, 10), 463.7], [gt(2016, 9, 11), 510], [gt(2016, 9, 12), 579.8], [gt(2016, 9, 13), 628.34],
						[gt(2016, 9, 15), 652.61], [gt(2016, 9, 18), 950.82], [gt(2016, 9, 19), 966.58], [gt(2016, 9, 20), 975.54], [gt(2016, 9, 21), 1008.53],
						[gt(2016, 9, 22), 1129.6]
					];
		}
